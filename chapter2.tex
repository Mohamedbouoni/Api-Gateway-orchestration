...
Figure~\ref{fig:usecase_general} presents the general use case diagram, grouping the platform's functionalities into five subsystem packages: Authentication, AI Orchestration, Runtime Policy Enforcement, Content Safety, and Administration. Governance configuration is handled by the Administrator; runtime policy and quota enforcement are automated.
